...
<body>
    <section id="wrapper">
        ...
        <section class="main-col">
            ...
            ?>
            <form class="blogger" action="/login" method="post">
                <div>
            ...
            <!-- <div class="blogger-notice"><a href="/contact">¿Aún no tienes cuenta? Contacta con un administrador para registrarte</a></div> -->
        </section>
        <aside class="sidebar">
